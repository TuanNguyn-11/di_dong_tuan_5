...
/** Vai trò của app này. Healthcare Map = người thân theo dõi. */
export const APP_ROLE: AppRole = 'guardian';
...
export const WRONG_ROLE_MESSAGE =
  'Email này đang là tài khoản NGƯỜI DÙNG (app Fall Guard), không đăng nhập được vào Healthcare Map. '
